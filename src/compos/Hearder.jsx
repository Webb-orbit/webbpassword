  ...
  return (
    ...
    <div className="h-[80vh] max-sm:h-[50vh] relative">
      <div className=" w-full h-full flex items-center justify-center flex-col max-sm:w-[70%] max-sm:mx-auto">
        <h1 className="itim text-[2.5rem] uppercase text-center">plain <span className=" font-medium text-[2.7rem]">write</span> execute</h1>
        <p className="poppins-regular text-[1rem]">focus in execution</p>
